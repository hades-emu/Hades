...
*/
char const *SHADER_FRAG_COLOR_CORRECTION_GBA_SP_101 = GLSL(
    ...
    const mat4 profile = mat4(
        0.965, 0.0345, -0.002, 0.0,  //red channel
        0.11, 0.89, -0.04, 0.0,  //green channel
        -0.075, 0.0755, 1.042, 0.0,  //blue channel
